...
dataset_train = pd.read_csv('Dossier_BasedeDonnées_en_sortie_de_MODELISATION/df_train_final.csv',index_col=0)
dataset_test = pd.read_csv('Dossier_BasedeDonnées_en_sortie_de_MODELISATION/df_test_final.csv',index_col=0)

target_train = pd.read_csv('Dossier_BasedeDonnées_en_sortie_de_MODELISATION/target_train_final.csv',index_col=0)
model = pickle.load(open('Dossier_BasedeDonnées_en_sortie_de_MODELISATION/best_model.pickle', 'rb'))
scaler = pickle.load(open('Dossier_BasedeDonnées_en_sortie_de_MODELISATION/scaler.pickle','rb'))
...
original_title = '<p style="font-family:Arial; color:Red; font-size: 60px;text-align: center;"> Dashbord de prediction de prêt bancaire</p>'
